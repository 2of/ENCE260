...
game.out: game.o ir_uart.o pio.o task.o system.o timer.o led.o timer0.o usart1.o display.o ledmat.o navswitch.o font.o pacer.o tinygl.o prescale.o button.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
